...
## Design Philosophy and Checkpoint Protocol

Read `${CLAUDE_SKILL_DIR}/references/design-philosophy.md` before creating or reviewing any skill. It contains the three governing principles (Declarative over Procedural, Environment Agnosticism, User Intent Empowerment) and the checkpoint format used throughout this workflow.
...
| `references/design-philosophy.md` | Governing principles (declarative, environment-agnostic, user intent) and checkpoint format |
